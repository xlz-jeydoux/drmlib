...
if read_the_docs_build:
    ...
    subprocess.call('apt-get  --assume-yes install libjsoncpp-dev', shell=True)
    subprocess.call('apt-get  --assume-yes install libcurl4-openssl-dev', shell=True)
    subprocess.call('apt-get  --assume-yes install unifdef', shell=True)
